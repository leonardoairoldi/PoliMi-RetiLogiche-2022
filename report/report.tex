...
L'intero progetto è stato sviluppato cercando di rendere il codice scritto il più chiaro possibile utilizzando pattern di programmazione VHDL e spezzando il dispositivo in sotto-moduli in modo da avere una chiara suddivisione delle funzionalità, aiutando nella progettazione dell'intera macchina, e in modo da avere codice riutilizzabile e facilmente interscambiabile con componenti di tipo diverso. Questo ha inoltre facilitato lo sviluppo del progetto in quanto il testing poteva essere effettuato sin dall'inizio sui singoli moduli.
